...
```typescript
import { TokenList, schema } from '@forbitswap/token-lists'
...
A snapshot of the Forbitswap default list encoded as a token list is found in [test/schema/bigexample.tokenlist.json](test/schema/bigexample.tokenlist.json).
